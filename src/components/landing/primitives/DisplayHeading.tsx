...
export function DisplayHeading({
  ...
  const variantStyles = {
    ...
    "hero-supporting":
      "text-[clamp(32px,8vw,52px)] sm:text-[clamp(40px,5vw,80px)] leading-[0.98] tracking-[-0.04em] font-semibold",
    section:
      "text-[clamp(36px,10vw,56px)] sm:text-[clamp(42px,5vw,88px)] leading-[0.95] tracking-[-0.045em] font-bold",
    subsection:
      "text-[clamp(24px,6vw,36px)] sm:text-[clamp(28px,3.5vw,44px)] leading-[1.05] tracking-[-0.035em] font-semibold",
  };
