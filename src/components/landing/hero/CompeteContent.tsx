      ...
      <div className="relative z-20 mx-auto w-full max-w-[1440px]">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            <DepthText depth={18} className="w-full">
              ...
              >
                ...
                <span className="block text-[#F5F2EA] text-[clamp(20px,2.8vw,36px)] leading-[1.15] mt-2 sm:mt-3 font-medium tracking-[-0.02em] drop-shadow-[0_2px_12px_rgba(9,9,11,0.75)]">
                  Build for something{" "}
                  <span className="text-cc-brand-gradient font-semibold">that matters.</span>
                </span>
              </h2>
            </DepthText>
            ...
            >
              People have connected. Now they build for a challenge. Compass Crew hackathons are
              where student teams turn collaboration into products that solve real problems, tested
              against real constraints and industry review.
            </p>
