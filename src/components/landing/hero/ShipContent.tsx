...
import { ArrowDown, CheckCircle2, Code2, ExternalLink, FileCheck, Layers, ShieldCheck } from "lucide-react";
 ...
 *   - Editorial copy: "Projects become opportunities when your work is visible, verifiable, and worth sharing.
 *     Compass Crew transforms code, live demos, and hackathon submissions into credible proof of work."
      ...
      <div className="relative z-20 mx-auto w-full max-w-[1440px]">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            >
              Building matters when it leaves the build room. Projects become opportunities when your work
              is visible, verifiable, and worth sharing. Compass Crew transforms raw code, live deployments,
              and hackathon submissions into verifiable proof that founders, recruiters, and collaborators respect.
            </p>
            ...
            >
              <div className="flex items-center gap-2 rounded-md border border-[#7DD3A8]/30 bg-[#111116]/80 px-3.5 py-1.5 backdrop-blur-md shadow-[0_0_15px_rgba(125,211,168,0.15)]">
                <span className="font-cc-mono text-[10.5px] sm:text-[11px] font-medium uppercase tracking-[0.16em] text-[#7DD3A8]">
            ...
            <div className="rounded-xl border border-white/10 bg-[#111116]/80 p-6 backdrop-blur-md font-cc-mono text-xs shadow-[0_8px_32px_rgba(0,0,0,0.5)]">
              <div className="flex items-center justify-between border-b border-white/10 pb-3 mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[#F5F2EA] font-semibold tracking-wider">PROOF CORE ARTIFACT</span>
                </div>
              ...
              <div className="space-y-3 text-[11px]">
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[10px] text-[#8C96AA]">SRC / BUILD / COMMIT</span>
                  </div>
                ...
                >
                  ...
                  <div className="mt-1 flex items-center justify-between text-[10px] text-[#8C96AA]">
                    <span>Production Preview URL</span>
                    <span className="text-[#7DD3A8]">ACTIVE DEMO</span>
                  </div>
                </div>

                {/* 3. Verification & Credential Layer */}
                <div
                  onMouseEnter={() => setActiveProofTab(2)}
                  onMouseLeave={() => setActiveProofTab(null)}
                  className={`rounded-lg border p-3 transition-all duration-200 ${
                    activeProofTab === 2
                      ? "border-[#FDE68A]/60 bg-[#FDE68A]/10"
                      : "border-white/5 bg-white/[0.02] hover:border-white/20"
                  }`}
                >
                  <div className="flex items-center justify-between">
                    <span className="text-[#FDE68A] font-semibold flex items-center gap-1.5">
                      <ShieldCheck className="h-3.5 w-3.5 text-[#FDE68A]" />
                      03 // VERIFIED CREDENTIAL
                    </span>
                    <span className="text-[10px] text-[#FDE68A]">PEER VALIDATED</span>
                  </div>
                  <div className="mt-1 flex items-center justify-between text-[10px] text-[#8C96AA]">
                    <span>Tamper-evident Milestone Record</span>
                    <span className="text-[#FDE68A]">VERIFIED</span>
                  </div>
                </div>

                {/* 4. Public Portfolio Layer */}
                <div
                  onMouseEnter={() => setActiveProofTab(3)}
                  onMouseLeave={() => setActiveProofTab(null)}
                  className={`rounded-lg border p-3 transition-all duration-200 ${
                    activeProofTab === 3
                      ? "border-[#B36BFF]/60 bg-[#B36BFF]/10"
                      : "border-white/5 bg-white/[0.02] hover:border-white/20"
                  }`}
                >
                  <div className="flex items-center justify-between">
                    <span className="text-[#B36BFF] font-semibold flex items-center gap-1.5">
                      <FileCheck className="h-3.5 w-3.5 text-[#B36BFF]" />
                      04 // PUBLIC PORTFOLIO
                    </span>
                    <span className="text-[10px] text-[#B36BFF]">SHAREABLE LINK</span>
                  </div>
                  <div className="mt-1 flex items-center justify-between text-[10px] text-[#8C96AA]">
                    <span>Proof of Capability for Recruiters & Founders</span>
                    <span className="text-[#B36BFF]">PUBLIC</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-4 pt-3 border-t border-white/10 flex items-center justify-between text-[10px] text-[#8C96AA] tracking-widest">
                <span className="flex items-center gap-1.5 text-[#F5F2EA]">
                  <CheckCircle2 className="h-3.5 w-3.5 text-[#7DD3A8]" />
                  PROOF OF WORK // COMPILED
                </span>
                <span className="text-[#7DD3A8]">READY TO GROW →</span>
              </div>
            </div>
          </div>
        </div>
