...
function TeamDetailPage() {
  ...
  const canInviteMore =
    activeMembers.length + invitedMembers.length + pendingInvites.length < maxSize;
  ...
  const invite = useMutation({
    ...
    onSuccess: (r) => {
      setInviteEmail("");
      toast.success(
        r.kind === "direct" ? "Invite sent to registered user" : "Email invitation created",
      );
                      ...
                      <li key={m.id} className="flex items-center justify-between gap-3 py-3">
                        <div className="flex min-w-0 items-center gap-3">
                          <Avatar className="h-9 w-9">
                            ...
                            <AvatarFallback>
                              {(m.profile?.full_name ?? "U").slice(0, 1)}
                            </AvatarFallback>
                          </Avatar>
                              ...
                              <AlertDialog>
                                ...
                                <AlertDialogContent>
                                  <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>
                                      You'll become a regular member and this person becomes the
                                      leader.
                                    </AlertDialogDescription>
                                  </AlertDialogHeader>
                                  <AlertDialogFooter>
                                    <AlertDialogCancel>Cancel</AlertDialogCancel>
                                    <AlertDialogAction onClick={() => transfer.mutate(m.user_id)}>
                                      Transfer
                                    </AlertDialogAction>
                                  </AlertDialogFooter>
                                </AlertDialogContent>
            ...
            {isLeader && !t.is_locked && (
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-muted-foreground">
                    By email. Registered users will see an invite instantly.
                  </p>
                  <form
                  ...
                  {!canInviteMore && (
                    <p className="mt-2 text-xs text-muted-foreground">
                      Team has reached the maximum size.
                    </p>
                  )}
                </CardContent>
              </Card>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Share with teammates when open joining is on.
                </p>
                ...
                {isLeader && (
                  <>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <Label className="flex items-center gap-2">
                          <Globe className="h-4 w-4" /> Open joining
                        </Label>
                    ...
                    <div className="mt-4 flex items-center justify-between">
                      <div>
                        <Label className="flex items-center gap-2">
                          <Lock className="h-4 w-4" /> Lock team
                        </Label>
                        <p className="text-xs text-muted-foreground">
                          Freeze members and invitations.
                        </p>
                      </div>
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            You'll be removed from this team immediately.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                          <AlertDialogCancel>Cancel</AlertDialogCancel>
                          <AlertDialogAction onClick={() => leave.mutate()}>
                            Leave
                          </AlertDialogAction>
                        </AlertDialogFooter>
                      </AlertDialogContent>
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            All members will be removed and any submission will be deleted. This
                            can't be undone.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
